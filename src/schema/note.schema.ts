...
export const GetNotesByLessonResponseSchema = z
  .object({
    message: z.string(),
    data: z
      .object({
  ...
  .strip();
export type GetNotesByLessonResponseType = z.infer<
  typeof GetNotesByLessonResponseSchema
>;

// Get Notes By Course Response - trả về course info, notes array với lesson info và total
export const GetNotesByCourseResponseSchema = z
  .object({
    message: z.string(),
    data: z.object({
      lessons: z.array(
  ...
  .strip();
export type GetNotesByCourseResponseType = z.infer<
  typeof GetNotesByCourseResponseSchema
>;

// Update Note Response - trả về note với lesson info
export const UpdateNoteResponseSchema = z
  .object({
    message: z.string(),
    data: NoteWithLessonSchema,
  })
