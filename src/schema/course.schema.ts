...
export const GetAllCourseResponseSchema = z
  .object({
    message: z.string(),
    data: z.object({
  ...
  .strip();
export type GetAllCourseResponseType = z.infer<
  typeof GetAllCourseResponseSchema
>;

export const GetCourseBySlugResponseSchema = z
  .object({
    message: z.string(),
    data: DetailCourseSchema,
  })
  .strip();
export type GetCourseBySlugResponseType = z.infer<
  typeof GetCourseBySlugResponseSchema
>;
// Admin course schema
export const AdminCourseItemSchema = z
  .object({
    id: z.string(),
    title: z.string(),
