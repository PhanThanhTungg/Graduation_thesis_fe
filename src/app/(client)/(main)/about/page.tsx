...
const values = [
  {
    ...
    title: "Our Mission",
    description:
      "To make quality education accessible to everyone, everywhere, empowering learners to achieve their full potential through innovative online learning experiences.",
  },
  {
    icon: Lightbulb,
    title: "Innovation",
    description:
      "We continuously innovate our platform with cutting-edge technology to provide the best learning experience for students and teaching tools for instructors.",
  },
  {
    icon: Users,
    title: "Community",
    description:
      "Building a global community of learners and educators who support, inspire, and learn from each other through collaborative learning.",
  },
  {
    icon: Award,
    title: "Excellence",
    description:
      "We maintain the highest standards in course quality, instructor expertise, and student support to ensure exceptional educational outcomes.",
  },
  {
    icon: BookOpen,
    title: "Accessibility",
    description:
      "Making education affordable and accessible to learners worldwide, breaking down barriers to knowledge and skill development.",
  },
  {
    icon: TrendingUp,
    title: "Growth",
    description:
      "Committed to continuous improvement and growth, helping our students advance their careers and achieve their personal goals.",
  },
];
      ...
      <section className="container-md py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed mb-8">
            We are a leading online learning platform dedicated to transforming
            education through technology. Our mission is to provide accessible,
            high-quality courses that help individuals achieve their personal
            ...
            >
              <defs>
                <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop
                    offset="0%"
                    style={{ stopColor: "#00a76f", stopOpacity: 0.6 }}
                  />
                  <stop
                    offset="100%"
                    style={{ stopColor: "#ff8e3c", stopOpacity: 0.6 }}
                  />
                </linearGradient>
              </defs>
              <circle
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row gap-6 items-center">
              ...
              <div className="md:w-2/3">
                ...
                <p className="text-base text-muted-foreground leading-relaxed">
                  Founded with a vision to democratize education, we started
                  with just 10 courses and a passionate team of educators. Our
                  goal was simple: make quality learning accessible to everyone.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse gap-6 items-center">
              ...
              <div className="md:w-2/3">
                ...
                <p className="text-base text-muted-foreground leading-relaxed">
                  We expanded to over 500 courses across multiple disciplines,
                  reaching 50,000+ students worldwide. Our platform became a
                  trusted destination for online learning.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center">
              ...
              <div className="md:w-2/3">
                ...
                <p className="text-base text-muted-foreground leading-relaxed">
                  Today, we serve 10,000+ active students with 1,000+ courses
                  taught by 500+ expert instructors. We continue to innovate and
        ...
        <div className="container-md">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              ...
              community of passionate learners and expert educators.
            </p>
